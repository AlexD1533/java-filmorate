...
class InMemoryUserStorageTest {
    ...
    void getUsersMap_ShouldReturnCopyOfInternalMap() {
        ...
        // Проверяем, что возвращается копия (изменения в оригинале не влияют на копию)
    ...
    void create_ShouldNotModifyOriginalObject() {
        ...
        // Then
        assertEquals(1, originalUser.getId()); // Исходный объект не должен измениться
        assertTrue(createdUser.getId() > 0);   // Созданный объект имеет ID
    }
